...
knitr::include_graphics("images/images2024/exec_summary1.png")
```
...
```{r}
#| echo: false
#| label: exec-summary-2
# fig-cap: A summary of the number of publications and rankings of terms across labels for Taxonomic, Common, Habitat and Place Names.
knitr::include_graphics("images/images2024/exec_summary2.png")
```
...
```{r}
#| echo: false
#| label: exec-summary-3
# fig-cap: A summary of the number of publications and rankings of terms across labels for Taxonomic, Common, Habitat and Place Names.
knitr::include_graphics("images/images2024/exec_summary3.png")
```
...
[\[1\]](#_ftnref1) See methodology

[\[2\]](#_ftnref2) WIPO Treaty on Intellectual Property, Genetic Resources, and Associated Traditional Knowledge, adopted on May 24 of 2024

[\[3\]](#_ftnref3) Depending on their origin, as they could come from areas within national jurisdiction, and the potential application of the retroactivity clause of the BBNJ Treaty
